...
export function Footer() {
  return (
    <footer className="mt-20 border-t border-border">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 text-foreground sm:grid-cols-2 md:grid-cols-4">
        <div>
          <div className="text-base font-bold text-foreground">QuickCompare</div>
